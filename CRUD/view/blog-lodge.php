      ...
      <section class="ftco-section">
        <div class="container mt-5">
            ...
            <div class="col-md-7 text-center heading-section ftco-animate">
              ...
              <h2>Le Lodge</h2>
              <br>
              <p>Création de la charte graphique et <br>de la carte du restaurant <em>Le Lodge</em></p>
            </div>
          </div>
          <div class="row d-flex justify-content-center">
            <div class="col-md-4">
              ...
              <p>
                  <a data-fancybox="gallery" href="../images/lelodge.jpg">
                <img src="../images/lelodge.jpg" alt="" class="img-fluid">
                </a>
              </p>
              <br>
              ...
              <div class="col-md-4">
                ...
                <p>
                    <a data-fancybox="gallery" href="../images/lelodge2.jpg">
                  <img src="../images/lelodge2.jpg" alt="" class="img-fluid">
                  </a>
                </p>
                <br>
